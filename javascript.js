...
document.getElementById('play').addEventListener('click', function() {
    ...
    tutorial.style.zIndex = 0;
});

const lessBut = document.querySelector('.tutorial span').addEventListener('click', function (){
    tutorial.style.opacity = 0;
    tutorial.style.zIndex = 0;

});
const tutoBut = document.getElementById('tuto').addEventListener('click', function(){
    tutorial.style.opacity = 100;
    tutorial.style.zIndex = 3;
});
